...
"""
    ...
    if resend_key:
        ...
        try:
            ...
            data = {
                "from": "AeroAssist <onboarding@resend.dev>",
                "to": to_email,
    ...
    sender_email = os.environ.get("SMTP_SENDER_EMAIL", "noreplyaeroassistapp@gmail.com")
    sender_password = os.environ.get("SMTP_SENDER_PASSWORD", "bxig ymbt ifsu lalk")
